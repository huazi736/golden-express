 ...
 * 
 * $Id: base.inc.php 201 2009-09-01 10:34:37Z suning $
 */
...
function _filter($str, $replace = false)
{
	global $cfg;
	include_once $cfg['path']['conf'] . 'filter.cfg.php';
	foreach ($cfg_filter as $v)
	{

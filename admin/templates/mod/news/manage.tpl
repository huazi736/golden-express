...
<table width="98%" border="0" align="center" cellpadding="4" cellspacing="1" class="content" bgcolor="#ffffff">
  <tr>
    <td colspan="5" height="25" class="title">新闻管理</td>
  </tr>
  <tr>
    <td width="9%" class="line"><strong>新闻ID</strong></td>
    <td width="58%" class="line"><strong>新闻标题</strong></td>
    <td width="15%" class="line"><strong>发布时间</strong></td>
    <td width="8%" class="line"><strong>置顶</strong></td>
    <td width="10%" class="line"><strong>管理</strong></td>
  </tr>
  {foreach from=$news item=list}
  <tr>
    <td class="line">{$list.NewsId}</td>
    <td class="line">{$list.Title}</td>
    <td class="line">{$list.CreateTime}</td>
    <td class="line">{if $list.Top == 1}是{else}否{/if}</td>
    <td class="line"><a href="?do=edit&nid={$list.NewsId}">编辑</a> <a href="?do=del&nid={$list.NewsId}" onclick="{literal}if(confirm('确定要删除新闻? 删除后无法恢复!')){return true}else{return false}{/literal}">删除</a></td>
  </tr>
  {/foreach}
  <tr>

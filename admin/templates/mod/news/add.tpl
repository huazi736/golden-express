...
<table width="98%" border="0" align="center" cellpadding="4" cellspacing="1" class="content" bgcolor="#ffffff">
  <tr>
    <td colspan="2" height="25" class="title">新闻发布</td>
  </tr>
  <tr>
    <td width="8%" class="line">标题<span class="red">*</span></td>
    <td width="92%" class="line"><input type="text" name="Title" class="txt input200" /></td>
  </tr>
  <tr>
    <td width="8%" class="line">作者</td>
    <td width="92%" class="line"><input type="text" name="Author" id="Author" class="txt input200" /></td>
  </tr>
  <tr>
    <td width="8%" class="line">来源</td>
    <td width="92%" class="line"><input type="text" name="From" id="From" class="txt input200" /></td>
  </tr>
  <tr>
    <td class="line">时间</td>
    <td class="line"><input type="text" name="CreateTime" id="CreateTime" class="txt input200" onclick="WdatePicker()" /></td>
  </tr>
  <tr>
    <td class="line">置顶</td>
    <td class="line"><input name="Top" type="checkbox" id="Top" value="1"  />
      置顶</td>
  </tr>
  <tr>
    <td class="line">标题颜色</td>
    <td class="line"><input type="radio" name="Color" id="radio" value="red" />
      <span class="red">红色</span> 
      <input type="radio" name="Color" id="radio2" value="green" />
 <span class="green">绿色</span>
<input type="radio" name="Color" id="radio3" value="blue" />
 <span class="blue">蓝色</span> </td>
  </tr>
  <tr>
    <td class="line">内容<span class="red">*</span></td>
    <td class="line"><textarea name="Content" id="Content" cols="45" rows="5"></textarea></td>
  </tr>
  <tr>
   <td>&nbsp;</td>
    <td><input type="submit" name="button" id="button" value="发布" class="btn" /></td>
  </tr>

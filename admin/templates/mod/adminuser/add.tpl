...
<table width="98%" border="0" align="center" cellpadding="4" cellspacing="1" class="content" bgcolor="#ffffff">
  <tr>
    <td colspan="2" height="25" class="title">添加帐号</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="92%" class="line"><input type="text" name="Name" class="txt input200" /></td>
  </tr>
  <tr>
    <td width="8%" class="line">密码</td>
    <td width="92%" class="line"><input type="password" name="Pass" class="txt input200" /></td>
  </tr>
  <tr>
    <td width="8%" class="line">Email</td>
    <td width="92%" class="line"><input type="text" name="Email" class="txt input200" /></td>
  </tr>
  <tr>
    <td class="line">联系电话</td>
    <td class="line"><input type="text" name="Phone" class="txt input200"  /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
